...
.headeroption {
  background: #5fcf80 url("img/php.png") no-repeat scroll 25px 12px;
  height: 74px;
  overflow: hidden;
  text-align: center;
}
...
.content{background: #fff;border: 6px solid #5fcf80;font-size: 16px;line-height: 22px;margin-bottom: 3px;margin-top: 3px;min-height: 380px;overflow: hidden;padding: 10px;}
...
.footeroption{height:90px;background:#5fcf80;overflow:hidden;padding-top:10px;}
.footerone {background: #474847;border-radius: 5px;float: left;font-size:18px;line-height:23px;margin-left: 10px;padding:6px 10px;text-align:center;width:390px;overflow: hidden;}
.footerone p{color: #fff; margin:0;}
</style>
</head>
<body>
  <header class="headeroption">
    <h2>Xây dựng Blog với PHP OOP [MVC]</h2>
